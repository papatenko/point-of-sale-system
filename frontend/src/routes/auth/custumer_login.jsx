...
export const Route = createFileRoute('/auth/custumer_login')({
...
function LoginCustomerComponent() {
  ...
  useEffect(() => {
    console.log("Login customer component");
  }, []);
...
const handleLogin = async (e) => {
  ...
  try {
    const res = await fetch('http://localhost:3000/api/login_customer', {
      method: 'POST',
      headers: {
